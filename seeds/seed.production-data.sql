...
ingredients,
measurements,
recipeIngredients RESTART IDENTITY CASCADE;
INSERT INTO users (user_name, password, full_name)
VALUES
  (
    'demo',
    '$2b$12$UAZpzmcYQ2MPKoaSCRZeGOduDQpt93Ds82TZI.XWux8WxRNoIVPLK',
    'John Doe'
  );
INSERT INTO recipes (user_id, title, recipe_description, instructions)
VALUES
  (
    1,
    'Spahgetti',
    'My take on spahgetti',
  ...
  (
    1,
    'Veggie Chilli',
    'A real, chunky, chili, without the meat. The right consistency to please your typical meat chili eater or the vegetarian looking for real chili.',
...
VALUES
  ...
  ('Dash');
-- 13
INSERT INTO recipeIngredients (recipe_id, ingredient_id, measure_id, quantity)
VALUES
  (1, 1, 9, 3),
  (1, 2, 10, 1),
  (1, 3, NULL, 2),
